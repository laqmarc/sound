...
const TremoloNode = ({ id, data, onDataChange }: ControllableSoundNodeProps) => {
  ...
  return (
    <div className="bg-amber-950/80 backdrop-blur-xl border border-amber-400/20 p-4 rounded-2xl shadow-2xl min-w-[260px]">
      ...
      <div className="flex bg-white/5 rounded-lg p-1 mb-4">
        <button
          ...
          className={`flex-1 text-[8px] py-1 rounded-md transition-all font-bold uppercase ${
            !sync ? 'bg-amber-300 text-black shadow-lg' : 'text-white/40 hover:text-white'
          }`}
        >
          Free
        </button>
      ...
      <div className="mt-4 pt-3 border-t border-white/5 flex items-center justify-between">
        <span className="text-[8px] uppercase tracking-[0.25em] text-white/35">Volume Pulse</span>
