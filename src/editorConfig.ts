...
export const machineSetTemplates: MachineSetTemplate[] = [
  ...
  },
  {
    id: 'ultimate-caos',
    name: 'Ultimate Caos',
    hint: 'ARP2 mutant cap a Shrine, Strip i Spectral Delay',
    tab: 'voices',
    nodes: [
      {
        key: 'arp2',
    ...
    edges: [
      { source: 'arp2', target: 'shrine', targetHandle: 'pitch' },
      { source: 'shrine', target: 'strip' },
      { source: 'strip', target: 'spectral' },
    ],
  },
];
...
export const addNodeButtons: AddNodeButton[] = [
  ...
  { type: 'channelStrip', label: 'Strip', color: 'bg-emerald-500/10 text-emerald-200 border-emerald-500/20', tab: 'fx' },
